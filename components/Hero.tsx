  ...
  return (
    <section
      ...
      bg-[#050816]
        ...
        bg-[url('data:image/svg+xml,%3Csvg%20width%3D%22120%22%20height%3D%22120%22%20viewBox%3D%220%200%20100%20100%22%20xmlns%3D%22http://www.w3.org/2000/svg%22%3E%3Cpath%20d%3D%22M50%200%20L100%2050%20L50%20100%20L0%2050%20Z%22%20fill%3D%22none%22%20stroke%3D%22%23ffffff10%22%20stroke-width%3D%221%22/%3E%3C/svg%3E')]
        bg-[length:180px]
      "
    >
      ...
      {/* BADGE */}
      <div className="mb-5 inline-flex items-center gap-2 rounded-full border border-purple-400/40 bg-white/5 px-4 py-1 text-xs font-medium text-purple-100/90">
        <span className="h-2 w-2 rounded-full bg-purple-400" />
        Web Solutions in One Place
      </div>

      {/* MAIN TITLE */}
      <h1 className="text-2xl sm:text-3xl md:text-5xl font-semibold max-w-3xl mx-auto leading-tight px-4">
